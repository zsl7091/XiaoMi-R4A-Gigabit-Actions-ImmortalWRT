#!/bin/bash
# 修改固件最大容量限制 (16MB 闪存减去 448KB 保留空间)
		...
		partitions {
			...
			factory: partition@40000 {
				...
				nvmem-layout {
					...
					#address-cells = <1>;
					#size-cells = <1>;
					eeprom_factory_0: eeprom@0 { reg = <0x0 0x400>; };
					eeprom_factory_8000: eeprom@8000 { reg = <0x8000 0x200>; };
					macaddr_factory_e000: macaddr@e000 { reg = <0xe000 0x6>; };
					macaddr_factory_e006: macaddr@e006 { reg = <0xe006 0x6>; };
				};
			};
			partition@50000 {
...
&pcie { status = "okay"; };
&pcie0 { wifi0: wifi@0,0 { compatible = "mediatek,mt76"; reg = <0x0000 0 0 0 0>; }; };
&pcie1 { wifi1: wifi@0,0 { compatible = "mediatek,mt76"; reg = <0x0000 0 0 0 0>; }; };
